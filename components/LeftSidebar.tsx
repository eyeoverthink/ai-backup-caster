    ...
    <section className={cn("left_sidebar h-[calc(100vh-5px)]", {
      ...
      <nav className="flex flex-col gap-6">
        ...
        {sidebarLinks.map(({ route, label, imgURL }) => {
          ...
          return <Link href={route} key={label} className={cn("flex gap-3 items-center py-4 max-lg:px-4 justify-center lg:justify-start text-white-2", {
            'bg-nav-focus border-r-4 border-orange-1 text-white-1': isActive
          })}>
